...
function! luis#internal#acc_text(pattern, sep, candidates, source) abort
...
function! luis#internal#choose_action(kind, candidate) abort
...
function! luis#internal#do_action(kind, action_name, candidate) abort
...
function! luis#internal#validate_kind(kind) abort
  return luis#schema#validate(s:SCHEMA_KIND, a:kind)
endfunction

function! luis#internal#validate_matcher(matcher) abort
  return luis#schema#validate(s:SCHEMA_MATCHER, a:matcher)
endfunction

function! luis#internal#validate_source(source) abort
